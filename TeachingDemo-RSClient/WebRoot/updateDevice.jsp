						...
						<section class="wrapper style5">
							<div class="inner">
                                <div class="6u 12u$(xsmall)">
										...
										<input type="button" value="Select" class="special" id="btnTest8">
								</div>  
								<h3>Information</h3>
								<form method="post" action="#">
										<div class="row uniform">
											<div class="6u 12u$(xsmall)">
												<input type="text" name="equNumber" id="equNumber" value="" readonly="readonly">
											</div>
											<div class="6u 12u$(xsmall)">
											...
											<div class="6u$ 12u$(xsmall)">
												<input type="text" name="equUnit" id="equUnit" value="" placeholder="Unit">
											</div>
											
											<div class="6u$ 12u$(xsmall)">
												<input type="text" name="equSta" id="equSta" value="" placeholder="Sta">
											</div>
											
											<div class="6u$ 12u$(xsmall)">
												<input type="text" name="equClass" id="equClass" value=""  readonly="readonly">
											</div>
											...
											<div class="12u$">
												<ul class="actions">
													<li><input type="button" value="Send Message" class="special" id="btnTest9"></li>
